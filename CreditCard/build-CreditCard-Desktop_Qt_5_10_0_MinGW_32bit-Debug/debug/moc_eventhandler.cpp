...
QT_MOC_LITERAL(1, 13, 12), // "samplesignal"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 15), // "cardNumberValid"
QT_MOC_LITERAL(4, 43, 18), // "cardNumberNotValid"
QT_MOC_LITERAL(5, 62, 15) // "onButtonClicked"

    },
    "EventHandler\0samplesignal\0\0cardNumberValid\0"
    "cardNumberNotValid\0onButtonClicked"
};
...
void EventHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->samplesignal(); break;
        case 1: _t->cardNumberValid(); break;
        case 2: _t->cardNumberNotValid(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventHandler::samplesignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (EventHandler::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventHandler::cardNumberValid)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (EventHandler::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&EventHandler::cardNumberNotValid)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void EventHandler::samplesignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void EventHandler::cardNumberValid()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void EventHandler::cardNumberNotValid()
{
